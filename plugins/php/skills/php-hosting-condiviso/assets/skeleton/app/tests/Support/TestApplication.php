...
/**
 * Applicazione completa con le definizioni di produzione, su una cartella dati temporanea,
 * SQLite e sessioni in memoria. Gestisce il cookie di sessione tra le richieste.
 */
