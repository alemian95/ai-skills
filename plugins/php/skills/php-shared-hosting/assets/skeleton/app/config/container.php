...
return [
    ...
    // Pipeline, from the outside in. BasePath first: the error pages need it too.
    // Parameter order = middleware order.
    RequestHandlerInterface::class => static fn(
        ...
        $errors,
        $session,
        new FastRoute($routes, $responses),  // routing first: correct 404/405 for POST/DELETE too
        $csrf,
